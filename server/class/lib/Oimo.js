...
OIMO.World.prototype = {
    ...
    clear:function(){
        ...
        for (var i in this.detectors){
            for (var i2 in this.detectors[i]){
                this.detectors[i][i2].world = this;
            }
        }
...
OIMO.SphereSphereCollisionDetector.prototype.detectCollision = function(shape1,shape2,manifold){
    ...
    if(len>0&&len<rad*rad){
        ...
        this.world.emit("collision", [shape1,shape2]);
    }
}
...
OIMO.BroadPhase = function(obj){
    this.types = 0x0;
    this.numPairChecks=0;
    this.numPairs=0;
    
    this.caller = (obj !== undefined) ? obj : {emit:function(){}};
